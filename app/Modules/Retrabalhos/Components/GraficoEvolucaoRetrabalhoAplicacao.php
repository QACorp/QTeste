...
class GraficoEvolucaoRetrabalhoAplicacao extends Component
{
    ...
    public function render(): View|Closure|string
    {
        ...
        $dadosAnoAtual = $this->dashboardBusiness->getTotalAplicacaoPorPeriodoAnual(EquipeUtils::equipeUsuarioLogado(), $this->ano);
        $aplicacoes = $this->aplicacaoBusiness->buscarTodos(EquipeUtils::equipeUsuarioLogado());
        $meses = DateHelper::getCollectionMeses();

        return view('retrabalhos::Components.grafico-evolucao-retrabalho-aplicacao', compact(
            'dadosAnoAtual',
            'aplicacoes',
            'meses'
        ));
