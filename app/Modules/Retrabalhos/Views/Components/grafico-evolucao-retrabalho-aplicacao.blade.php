...
<div>
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Retrabalho por aplicação</h3>

        </div>

        <div class="card-body">
            <div><canvas id="retrabalhos-aplicacao-anual"></canvas></div>
        </div>
    </div>
</div>
...
@push('js')
    <script>
        ...
        (async function comparacaoAnual() {
            ...
            new Chart(
                document.getElementById('retrabalhos-aplicacao-anual').getContext("2d"),
                {
                    type: 'line',
                    data: datasets
                }
