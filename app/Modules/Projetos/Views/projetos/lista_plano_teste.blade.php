<div class="card">
    <div class="card-header">
        ...
        @can(\App\System\Enuns\PermisissionEnum::INSERIR_PLANO_TESTE->value)
            <a class="btn btn-primary btn-sm" href="{{route('aplicacoes.projetos.planos-teste.inserir',[$projeto->aplicacao_id, $projeto->id])}}"><i class="fas fa-plus"></i></a>
        @endcan
    </div>
    <div class="card-body">
            ...
            @foreach($planosTeste as $plano_teste)
                <tr>
                    ...
                    <td>
                        ...
                        <a class="btn btn-primary btn-sm" title="Visualizar" href="{{ route('aplicacoes.projetos.planos-teste.visualizar',[$projeto->aplicacao_id, $projeto->id, $plano_teste->id]) }}"><i class="fas fa-eye"></i> </a>
